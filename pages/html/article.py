...
# Base article Navbar
article_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_article_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
article_simulator_navbar = html.Div(
    # article Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Article() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Article() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
