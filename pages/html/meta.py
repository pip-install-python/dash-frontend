...
# Base meta Navbar
meta_navbar = dmc.MantineProvider(
...
meta_simulator_navbar = html.Div(
    # meta Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Meta() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Meta() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_meta",
)

meta_showcase = html.Div(
    [
        meta_navbar,
        html.Div(
            [
