...
# Base blockquote Navbar
blockquote_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_blockquote_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
blockquote_simulator_navbar = html.Div(
    # blockquote Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
            dmc.Paper(
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Blockquote() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Blockquote() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
blockquote_example_code = html.Div(
    [
        dmc.Prism(
...
blockquote_attributes = html.Div(
    [
        dmc.Prism(
            """
Attributes
