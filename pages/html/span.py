...
# Base span Navbar
span_navbar = dmc.MantineProvider(
...
span_simulator_navbar = html.Div(
    # span Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Span() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Span() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_span",
)

span_showcase = html.Div(
    [
        span_navbar,
        html.Div(
            [
