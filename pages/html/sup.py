...
# Base sup Navbar
sup_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Sup() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Sup() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
