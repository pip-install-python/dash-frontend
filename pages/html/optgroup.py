...
# Base optgroup Navbar
optgroup_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_optgroup_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
optgroup_simulator_navbar = html.Div(
    # optgroup Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Optgroup() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Optgroup() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_optgroup",
)

optgroup_showcase = html.Div(
    [
        optgroup_navbar,
        html.Div(
            [
...
optgroup_example_code = html.Div(
    [
        dmc.Prism(
