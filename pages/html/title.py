...
# Base Title Navbar
title_navbar = dmc.MantineProvider(
...
title_simulator_navbar = html.Div(
    # title Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Title() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Title() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_title",
)

title_showcase = html.Div(
    [
        title_navbar,
        html.Div(
            [
