...
# Base area Navbar
area_navbar = dmc.MantineProvider(
...
area_simulator_navbar = html.Div(
    # area Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Area() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Area() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
