...
# Base search Navbar
search_navbar = dmc.MantineProvider(
...
search_simulator_navbar = html.Div(
    # search Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Search() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Search() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_search",
)

search_showcase = html.Div(
    [
        search_navbar,
        html.Div(
            [
