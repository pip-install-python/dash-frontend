...
# Base center Navbar
center_navbar = dmc.MantineProvider(
...
center_simulator_navbar = html.Div(
    # center Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Center() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Center() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
