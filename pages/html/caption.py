...
# Base caption Navbar
caption_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_caption_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
caption_simulator_navbar = html.Div(
    # caption Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Caption() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Caption() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
