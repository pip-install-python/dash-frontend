...
# Base data Navbar
data_navbar = dmc.MantineProvider(
...
data_simulator_navbar = html.Div(
    # data Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Data() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Data() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
