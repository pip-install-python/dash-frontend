...
# Base Navbar
video_navbar = dmc.MantineProvider(
        ...
        dmc.Group([
            dmc.Tooltip(
                ...
                children=[dmc.ActionIcon(
                    ...
                    id='card_video_simulator', n_clicks=1,
                )]
            ),
            dmc.Tooltip(
                label="Showcase",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        variant='transparent', id='card_video_showcase', n_clicks=1,
                    ),
                ]),
            dmc.Tooltip(
                label="Example Code",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        n_clicks=1,
                        variant='transparent', id='card_video_simulator_code'
                    ),
                ]),
            dmc.Tooltip(
                label="Attributes",
...
video_simulator_navbar = html.Div(
    # A Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
            dmc.Paper([
                ...
                dmc.Group([
                    dmc.Tooltip(
                        ...
                        offset=3,
                        children=[dmc.ActionIcon(
                            DashIconify(icon="logos:python", width=30, ), variant='transparent', id='card_video_simulator',
                            n_clicks=1,
                        )]
                    ),
                    dmc.Tooltip(
                    ...
                    dmc.Tooltip(
                        ...
                        children=[
                            dmc.ActionIcon(
                                ...
                                variant='transparent', id='card_video_simulator_code', n_clicks=1,
                            ),
                        ]),
                    dmc.Tooltip(
                        label="Attributes",
                        ...
                        children=[
                            dmc.ActionIcon(
                                DashIconify(icon="vscode-icons:file-type-poedit", width=30, ), variant='transparent',
                                id='card_video_attributes', n_clicks=1,
                            ),
                        ])
                ], position='center'),
                html.Hr(),
                html.Div([
                    dmc.Container([
                        dmc.Title("Custom html.Video() Simulator",
                                  order=2),
                        html.Div([
                            html.Label(
                                "The dash.html.A() component is used to create hyperlinks. Here are some examples:",
    ...
    , id='card_display_video')

video_showcase = html.Div([
    video_navbar,
    html.Div([
        html.Div([
            dmc.Prism(
...
html.A("A Tag Homepage #",
        ...
        html.Div(dmc.MantineProvider(
            ...
            children=[dmc.Paper(dbc.Container([html.H1("Understanding the HTML <a> Element"),
                                               html.P([
                                                   "The ", html.Code("<a>"),
                                                   " HTML element (or anchor element), with its ", html.Code("href"),
                                               ...
                                               html.P([
                                                   "Content within each ", html.Code("<a>"),
