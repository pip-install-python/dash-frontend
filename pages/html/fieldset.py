...
# Base fieldset Navbar
fieldset_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_fieldset_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
fieldset_simulator_navbar = html.Div(
    # fieldset Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Fieldset() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Fieldset() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
fieldset_example_code = html.Div(
    [
        dmc.Prism(
