...
# Base time Navbar
time_navbar = dmc.MantineProvider(
...
time_simulator_navbar = html.Div(
    # A Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Time() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
    ...
    id="card_display_time",
)

time_showcase = html.Div(
    [
        time_navbar,
        html.Div(
            [
