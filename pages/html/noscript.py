...
# Base noscript Navbar
noscript_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_noscript_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
noscript_simulator_navbar = html.Div(
    # noscript Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Noscript() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Noscript() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_noscript",
)

noscript_showcase = html.Div(
    [
        noscript_navbar,
        html.Div(
            [
...
noscript_example_code = html.Div(
    [
        dmc.Prism(
