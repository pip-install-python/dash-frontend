...
# Base figure Navbar
figure_navbar = dmc.MantineProvider(
...
figure_simulator_navbar = html.Div(
    # figure Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Figure() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Figure() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
