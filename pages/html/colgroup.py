...
# Base colgroup Navbar
colgroup_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_colgroup_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
colgroup_simulator_navbar = html.Div(
    # colgroup Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Colgroup() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Colgroup() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
colgroup_example_code = html.Div(
    [
        dmc.Prism(
