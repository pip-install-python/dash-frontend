        ...
        dmc.Group([
            dmc.Tooltip(
                ...
                children=[dmc.ActionIcon(
                    ...
                    id='card_u_simulator', n_clicks=1,
                )]
            ),
            dmc.Tooltip(
                label="Showcase",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        variant='transparent', id='card_u_showcase', n_clicks=1,
                    ),
                ]),
            dmc.Tooltip(
                label="Example Code",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        n_clicks=1,
                        variant='transparent', id='card_u_simulator_code'
                    ),
                ]),
            dmc.Tooltip(
                label="Attributes",
            ...
            dmc.Paper([
                ...
                dmc.Group([
                    dmc.Tooltip(
                        ...
                        offset=3,
                        children=[dmc.ActionIcon(
                            DashIconify(icon="logos:python", width=30, ), variant='transparent', id='card_u_simulator',
                            n_clicks=1,
                        )]
                    ),
                    dmc.Tooltip(
                    ...
                    dmc.Tooltip(
                        ...
                        children=[
                            dmc.ActionIcon(
                                ...
                                variant='transparent', id='card_u_simulator_code', n_clicks=1,
                            ),
                        ]),
                    dmc.Tooltip(
                        label="Attributes",
                        ...
                        children=[
                            dmc.ActionIcon(
                                DashIconify(icon="vscode-icons:file-type-poedit", width=30, ), variant='transparent',
                                id='card_u_attributes', n_clicks=1,
                            ),
                        ])
                ], position='center'),
                html.Hr(),
                html.Div([
                    dmc.Container([
                        dmc.Title("Custom html.U() Simulator",
                                  order=2),
                        html.Div([
                            html.Label(
