...
# Base object Navbar
object_navbar = dmc.MantineProvider(
...
object_simulator_navbar = html.Div(
    # object Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Object() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Object() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_object",
)

object_showcase = html.Div(
    [
        object_navbar,
        html.Div(
            [
