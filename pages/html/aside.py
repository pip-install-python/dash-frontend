...
# Base aside Navbar
aside_navbar = dmc.MantineProvider(
...
aside_simulator_navbar = html.Div(
    # aside Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Aside() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Aside() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
