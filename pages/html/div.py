...
# Base div Navbar
div_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Div() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Div() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
