...
# Base pre Navbar
pre_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Pre() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Pre() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
