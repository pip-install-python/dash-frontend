...
# Base frameset Navbar
frameset_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_frameset_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
frameset_simulator_navbar = html.Div(
    # frameset Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Frameset() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Frameset() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
frameset_example_code = html.Div(
    [
        dmc.Prism(
