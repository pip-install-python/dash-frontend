...
# Base font Navbar
font_navbar = dmc.MantineProvider(
...
font_simulator_navbar = html.Div(
    # font Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Font() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Font() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
