...
# Base picture Navbar
picture_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_picture_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
picture_simulator_navbar = html.Div(
    # picture Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Picture() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
    ...
    id="card_display_picture",
)

picture_showcase = html.Div(
    [
        picture_navbar,
        html.Div(
            [
