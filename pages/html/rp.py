                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Rp() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Rp() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
rp_example_code = html.Div(
    [
        dmc.Prism(
            """# Dash html.Rp() Simulator
