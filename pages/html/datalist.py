...
# Base datalist Navbar
datalist_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_datalist_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
datalist_simulator_navbar = html.Div(
    # datalist Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Datalist() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
...
datalist_example_code = html.Div(
    [
        dmc.Prism(
