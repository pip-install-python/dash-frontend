...
# Base canvas Navbar
canvas_navbar = dmc.MantineProvider(
...
canvas_simulator_navbar = html.Div(
    # canvas Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Canvas() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Canvas() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
