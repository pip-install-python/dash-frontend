...
# Base input Navbar
input_navbar = dmc.MantineProvider(
...
input_simulator_navbar = html.Div(
    # input Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Input() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Input() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
