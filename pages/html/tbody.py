...
# Base tbody Navbar
tbody_navbar = dmc.MantineProvider(
...
tbody_simulator_navbar = html.Div(
    # tbody Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Tbody() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Tbody() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
html.A("A Tag Homepage #",
    ...
    style={"margin": 0, "padding": 0},
    id="card_display_tbody",
)

tbody_example_code = html.Div(
    [
        dmc.Prism(
