            ...
            dmc.Group([
                dmc.Tooltip(
                    ...
                    children=[dmc.ActionIcon(
                        ...
                        id='card_a_simulator', n_clicks=1,
                    )]
                ),
                dmc.Tooltip(
                    label="Showcase",
                    ...
                    children=[
                        dmc.ActionIcon(
                            ...
                            variant='transparent', id='card_a_showcase', n_clicks=1,
                        ),
                    ]),
                dmc.Tooltip(
                    label="Example Code",
                    ...
                    children=[
                        dmc.ActionIcon(
                            ...
                            n_clicks=1,
                            variant='transparent', id='card_a_simulator_code'
                        ),
                    ]),
                dmc.Tooltip(
                    label="Attributes",
                                    ...
                                    dmc.Space(h=10),
                                           dmc.Group([
                                                        dmc.Tooltip(
                                                            ...
                                                            offset=3,
                                                            children=[dmc.ActionIcon(
                                                            DashIconify(icon="logos:python", width=30,), variant='transparent', id='card_a_simulator', n_clicks=1,
                                                        )]
                                                        ),
                                                dmc.Tooltip(
                                                   label="Showcase",
                                                   ...
                                                   children=[
                                                       dmc.ActionIcon(
                                                            DashIconify(icon="streamline-emojis:open-book", width=30,), color="blue", variant='transparent', id='card_a_showcase', n_clicks=1,
                                                        ),
                                                       ]),
                                               dmc.Tooltip(
                                                   label="Example Code",
                                                   ...
                                                   children=[
                                                       dmc.ActionIcon(
                                                            DashIconify(icon="vscode-icons:folder-type-python-opened", width=30,), color="blue", variant='transparent', id='card_a_simulator_code', n_clicks=1,
                                                        ),
                                                       ]),
                                                dmc.Tooltip(
                                                            label="Attributes",
                                                            ...
                                                            children=[
                                                        dmc.ActionIcon(
                                                            DashIconify(icon="vscode-icons:file-type-poedit", width=30,),  variant='transparent', id='card_a_attributes', n_clicks=1,
                                                        ),
                                                                ])
                                                      ], position='center'),
                                html.Hr(),
...
a_showcase = html.Div([
    ...
    html.A("A Tag Homepage #",
            ...
            html.Div(html.Center(html.A("A Tag Homepage #",
              href="#",
            ...
            html.Div(dmc.MantineProvider(
                            theme={"colorScheme": "dark"},
                            children=[dmc.Paper(dbc.Container([html.H1("Understanding the HTML <a> Element"),
                                  html.P([
                                      "The ", html.Code("<a>"), " HTML element (or anchor element), with its ", html.Code("href"),
                                  ...
                                  html.P([
                                      "Content within each ", html.Code("<a>"), " should indicate the link's destination. If the ",
                                      html.Code("href"), " attribute is present, pressing the enter key while focused on the ",
                                      html.Code("<a>"), " element will activate it."
                                  ])]))],
                        ), style={'margin': 0,
                                   'padding': 0,
                                   'position': 'relative',
                                   ...
                                   },)], style={'position':'relative', 'top':-20, 'height': '60vh',
                   'overflow-y': 'scroll'}),
        ], style={'margin': 0,
