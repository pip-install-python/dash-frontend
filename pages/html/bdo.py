...
# Base bdo Navbar
bdo_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Bdo() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Bdo() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
