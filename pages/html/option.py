...
# Base option Navbar
option_navbar = dmc.MantineProvider(
...
option_simulator_navbar = html.Div(
    # option Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Option() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Option() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_option",
)

option_showcase = html.Div(
    [
        option_navbar,
        html.Div(
            [
