...
# Base table Navbar
table_navbar = dmc.MantineProvider(
...
table_simulator_navbar = html.Div(
    # A Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Table() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Table() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
