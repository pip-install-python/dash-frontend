...
# Base Navbar
track_navbar = dmc.MantineProvider(
        ...
        dmc.Group([
            dmc.Tooltip(
                ...
                children=[dmc.ActionIcon(
                    ...
                    id='card_track_simulator', n_clicks=1,
                )]
            ),
            dmc.Tooltip(
                label="Showcase",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        variant='transparent', id='card_track_showcase', n_clicks=1,
                    ),
                ]),
            dmc.Tooltip(
                label="Example Code",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        n_clicks=1,
                        variant='transparent', id='card_track_simulator_code'
                    ),
                ]),
            dmc.Tooltip(
                label="Attributes",
...
track_simulator_navbar = html.Div(
    # A Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
            dmc.Paper([
                ...
                dmc.Group([
                    dmc.Tooltip(
                        ...
                        offset=3,
                        children=[dmc.ActionIcon(
                            DashIconify(icon="logos:python", width=30, ), variant='transparent', id='card_track_simulator',
                            n_clicks=1,
                        )]
                    ),
                    dmc.Tooltip(
                    ...
                    dmc.Tooltip(
                        ...
                        children=[
                            dmc.ActionIcon(
                                ...
                                variant='transparent', id='card_track_simulator_code', n_clicks=1,
                            ),
                        ]),
                    dmc.Tooltip(
                        label="Attributes",
                        ...
                        children=[
                            dmc.ActionIcon(
                                DashIconify(icon="vscode-icons:file-type-poedit", width=30, ), variant='transparent',
                                id='card_track_attributes', n_clicks=1,
                            ),
                        ])
                ], position='center'),
                html.Hr(),
                html.Div([
                    dmc.Container([
                        dmc.Title("Custom html.Track() Simulator",
                                  order=2),
                        html.Div([
                            html.Label(
