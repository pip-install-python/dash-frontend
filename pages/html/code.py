...
# Base code Navbar
code_navbar = dmc.MantineProvider(
...
code_simulator_navbar = html.Div(
    # code Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
