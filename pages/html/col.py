...
# Base col Navbar
col_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Col() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Col() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
