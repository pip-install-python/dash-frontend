...
# Base samp Navbar
samp_navbar = dmc.MantineProvider(
...
samp_simulator_navbar = html.Div(
    # samp Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Samp() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Samp() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_samp",
)

samp_showcase = html.Div(
    [
        samp_navbar,
        html.Div(
            [
