...
# Base figcaption Navbar
figcaption_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_figcaption_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
figcaption_simulator_navbar = html.Div(
    # figcaption Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
            dmc.Paper(
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Figcaption() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Figcaption() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
figcaption_example_code = html.Div(
    [
        dmc.Prism(
...
figcaption_attributes = html.Div(
    [
        dmc.Prism(
            """
Attributes
