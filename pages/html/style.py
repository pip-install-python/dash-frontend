...
# Base style Navbar
style_navbar = dmc.MantineProvider(
...
style_simulator_navbar = html.Div(
    # style Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Style() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Style() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
