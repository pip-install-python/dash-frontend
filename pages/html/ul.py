        ...
        dmc.Group([
            dmc.Tooltip(
                ...
                children=[dmc.ActionIcon(
                    ...
                    id='card_ul_simulator', n_clicks=1,
                )]
            ),
            dmc.Tooltip(
                label="Showcase",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        variant='transparent', id='card_ul_showcase', n_clicks=1,
                    ),
                ]),
            dmc.Tooltip(
                label="Example Code",
                ...
                children=[
                    dmc.ActionIcon(
                        ...
                        n_clicks=1,
                        variant='transparent', id='card_ul_simulator_code'
                    ),
                ]),
            dmc.Tooltip(
                label="Attributes",
            ...
            dmc.Paper([
                ...
                dmc.Group([
                    dmc.Tooltip(
                        ...
                        offset=3,
                        children=[dmc.ActionIcon(
                            DashIconify(icon="logos:python", width=30, ), variant='transparent', id='card_ul_simulator',
                            n_clicks=1,
                        )]
                    ),
                    dmc.Tooltip(
                    ...
                    dmc.Tooltip(
                        ...
                        children=[
                            dmc.ActionIcon(
                                ...
                                variant='transparent', id='card_ul_simulator_code', n_clicks=1,
                            ),
                        ]),
                    dmc.Tooltip(
                        label="Attributes",
                        ...
                        children=[
                            dmc.ActionIcon(
                                DashIconify(icon="vscode-icons:file-type-poedit", width=30, ), variant='transparent',
                                id='card_ul_attributes', n_clicks=1,
                            ),
                        ])
                ], position='center'),
                html.Hr(),
                html.Div([
                    dmc.Container([
                        dmc.Title("Custom html.Ul() Simulator",
                                  order=2),
                        html.Div([
                            html.Label(
...
html.A("A Tag Homepage #",
        ...
        html.Div(dmc.MantineProvider(
          ...
          'padding': 0}, id='card_display_ul')

ul_example_code = html.Div([
    dmc.Prism(
