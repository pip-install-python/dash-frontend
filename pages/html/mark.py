...
# Base mark Navbar
mark_navbar = dmc.MantineProvider(
...
mark_simulator_navbar = html.Div(
    # mark Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Mark() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Mark() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_mark",
)

mark_showcase = html.Div(
    [
        mark_navbar,
        html.Div(
            [
