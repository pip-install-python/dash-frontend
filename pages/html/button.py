...
# Base button Navbar
button_navbar = dmc.MantineProvider(
...
button_simulator_navbar = html.Div(
    # button Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Button() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Button() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
