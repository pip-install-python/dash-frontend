...
# Base details Navbar
details_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_details_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
details_simulator_navbar = html.Div(
    # details Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Details() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Details() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
