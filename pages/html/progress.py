...
# Base progress Navbar
progress_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_progress_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
progress_simulator_navbar = html.Div(
    # progress Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Progress() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Progress() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_progress",
)

progress_showcase = html.Div(
    [
        progress_navbar,
        html.Div(
            [
...
progress_example_code = html.Div(
    [
        dmc.Prism(
