...
# Base audio Navbar
audio_navbar = dmc.MantineProvider(
...
audio_simulator_navbar = html.Div(
    # audio Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Audio() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Audio() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
