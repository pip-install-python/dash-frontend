...
# Base select Navbar
select_navbar = dmc.MantineProvider(
...
select_simulator_navbar = html.Div(
    # select Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Select() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Select() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_select",
)

select_showcase = html.Div(
    [
        select_navbar,
        html.Div(
            [
