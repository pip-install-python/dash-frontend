...
# Base ins Navbar
ins_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Ins() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Ins() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
