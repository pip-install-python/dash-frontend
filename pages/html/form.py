...
# Base from Navbar
from_navbar = dmc.MantineProvider(
...
from_simulator_navbar = html.Div(
    # from Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.From() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.From() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_from",
)

from_showcase = html.Div(
    [
        from_navbar,
        html.Div(
            [
