...
# Base head Navbar
head_navbar = dmc.MantineProvider(
...
head_simulator_navbar = html.Div(
    # head Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Head() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Head() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
