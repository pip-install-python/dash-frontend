...
# Base label Navbar
label_navbar = dmc.MantineProvider(
...
label_simulator_navbar = html.Div(
    # label Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Label() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Label() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_label",
)

label_showcase = html.Div(
    [
        label_navbar,
        html.Div(
            [
