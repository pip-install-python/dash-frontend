...
# Base plaintext Navbar
plaintext_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_plaintext_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
plaintext_simulator_navbar = html.Div(
    # plaintext Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Plaintext() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Plaintext() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_plaintext",
)

plaintext_showcase = html.Div(
    [
        plaintext_navbar,
        html.Div(
            [
...
plaintext_example_code = html.Div(
    [
        dmc.Prism(
