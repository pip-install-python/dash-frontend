...
# Base param Navbar
param_navbar = dmc.MantineProvider(
...
param_simulator_navbar = html.Div(
    # param Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Param() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Param() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_param",
)

param_showcase = html.Div(
    [
        param_navbar,
        html.Div(
            [
