...
# Base tfoot Navbar
tfoot_navbar = dmc.MantineProvider(
...
tfoot_simulator_navbar = html.Div(
    # tfoot Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.tfoot() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
    ...
    id="card_display_tfoot",
)

tfoot_showcase = html.Div(
    [
        tfoot_navbar,
        html.Div(
            [
