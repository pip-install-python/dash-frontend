...
# Base ruby Navbar
ruby_navbar = dmc.MantineProvider(
...
ruby_simulator_navbar = html.Div(
    # ruby Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Ruby() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Ruby() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_ruby",
)

ruby_showcase = html.Div(
    [
        ruby_navbar,
        html.Div(
            [
