...
# Base rtc Navbar
rtc_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Rtc() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Rtc() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
