...
# Base header Navbar
header_navbar = dmc.MantineProvider(
...
header_simulator_navbar = html.Div(
    # header Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Header() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Header() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
