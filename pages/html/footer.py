...
# Base footer Navbar
footer_navbar = dmc.MantineProvider(
...
footer_simulator_navbar = html.Div(
    # footer Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Footer() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Footer() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_footer",
)

footer_showcase = html.Div(
    [
        footer_navbar,
        html.Div(
            [
