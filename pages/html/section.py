...
# Base section Navbar
section_navbar = dmc.MantineProvider(
                        ...
                        dmc.Tooltip(
                            ...
                            children=[
                                dmc.ActionIcon(
                                    ...
                                    n_clicks=1,
                                    variant="transparent",
                                    id="card_section_simulator_code",
                                ),
                            ],
                        ),
                        dmc.Tooltip(
...
section_simulator_navbar = html.Div(
    # section Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Section() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Section() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_section",
)

section_showcase = html.Div(
    [
        section_navbar,
        html.Div(
            [
