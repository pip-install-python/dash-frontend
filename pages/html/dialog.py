...
# Base dialog Navbar
dialog_navbar = dmc.MantineProvider(
...
dialog_simulator_navbar = html.Div(
    # dialog Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Dialog() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Dialog() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
