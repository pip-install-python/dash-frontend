...
# Base thread Navbar
thread_navbar = dmc.MantineProvider(
...
thread_simulator_navbar = html.Div(
    # thread Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Thread() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
