...
marque_simulator_navbar = html.Div(
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
            dmc.Paper(
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title(
                                        "Custom html.Marquee() Simulator", order=2
                                    ),
                                    dmc.Select(
                                        label="Direction",
                                    ...
                                    dmc.Switch(
                                        label="True Speed", id="true-speed-switch"
                                    ),
                                    dmc.Button(
                                        "Start",
                                        id="start-btn",
                                    ...
                                    dmc.Button("Stop", id="stop-btn", color="red"),
                                    html.Div(
