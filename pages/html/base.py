...
# Base Navbar
base_navbar = dmc.MantineProvider(
...
base_simulator_navbar = html.Div(
    # base Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Base() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Base() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
