...
# Base source Navbar
source_navbar = dmc.MantineProvider(
...
source_simulator_navbar = html.Div(
    # source Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Source() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Source() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_source",
)

source_showcase = html.Div(
    [
        source_navbar,
        html.Div(
            [
