...
# Base slot Navbar
slot_navbar = dmc.MantineProvider(
...
slot_simulator_navbar = html.Div(
    # slot Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Slot() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Slot() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_slot",
)

slot_showcase = html.Div(
    [
        slot_navbar,
        html.Div(
            [
