...
# Base dfn Navbar
dfn_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Dfn() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Dfn() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
