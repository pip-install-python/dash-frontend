...
# Base link Navbar
link_navbar = dmc.MantineProvider(
...
link_simulator_navbar = html.Div(
    # link Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Link() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Link() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_link",
)

link_showcase = html.Div(
    [
        link_navbar,
        html.Div(
            [
