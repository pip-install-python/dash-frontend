...
# Base iframe Navbar
iframe_navbar = dmc.MantineProvider(
...
iframe_simulator_navbar = html.Div(
    # iframe Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Iframe() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Iframe() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
