                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.P() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.P() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
p_example_code = html.Div(
    [
        dmc.Prism(
            """# Dash html.P() Simulator
