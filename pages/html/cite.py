...
# Base cite Navbar
cite_navbar = dmc.MantineProvider(
...
cite_simulator_navbar = html.Div(
    # cite Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Cite() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Cite() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
