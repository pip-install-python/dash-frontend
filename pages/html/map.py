...
# Base map Navbar
map_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Map() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Map() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
