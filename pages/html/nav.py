...
# Base nav Navbar
nav_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Nav() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Nav() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
...
nav_example_code = html.Div(
    [
        dmc.Prism(
            """# Dash html.Nav() Simulator
