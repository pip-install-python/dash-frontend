...
# Base output Navbar
output_navbar = dmc.MantineProvider(
...
output_simulator_navbar = html.Div(
    # output Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Output() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Output() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_output",
)

output_showcase = html.Div(
    [
        output_navbar,
        html.Div(
            [
