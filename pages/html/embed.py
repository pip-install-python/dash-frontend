...
# Base embed Navbar
embed_navbar = dmc.MantineProvider(
...
embed_simulator_navbar = html.Div(
    # embed Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Embed() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Embed() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
