...
# Base del Navbar
del_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Del() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Del() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
