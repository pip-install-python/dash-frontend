...
# Base Navbar
small_navbar = dmc.MantineProvider(
...
small_simulator_navbar = html.Div(
    # Small Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Small() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Small() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
