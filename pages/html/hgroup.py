...
# Base hgroup Navbar
hgroup_navbar = dmc.MantineProvider(
...
hgroup_simulator_navbar = html.Div(
    # hgroup Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Hgroup() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Hgroup() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
