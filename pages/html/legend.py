...
# Base legend Navbar
legend_navbar = dmc.MantineProvider(
...
legend_simulator_navbar = html.Div(
    # A Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Legend() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Legend() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_legend",
)

legend_showcase = html.Div(
    [
        legend_navbar,
        html.Div(
            [
...
legend_example_code = html.Div(
    [
        dmc.Prism(
            """# Dash html.Legend() Simulator
