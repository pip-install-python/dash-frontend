...
# Base frame Navbar
frame_navbar = dmc.MantineProvider(
...
frame_simulator_navbar = html.Div(
    # frame Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Frame() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Frame() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_frame",
)

frame_showcase = html.Div(
    [
        frame_navbar,
        html.Div(
            [
