...
# Base bdi Navbar
bdi_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Bdi() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Bdi() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
