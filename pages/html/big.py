...
# Base big Navbar
big_navbar = dmc.MantineProvider(
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Big() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Big() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
