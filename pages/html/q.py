                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Q() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Q() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
                                                    "font-family": '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
                                                },
                                            ),
                                            # Example of q simple link
                                            html.A(
                                                "A Tag Homepage #",
                                                href="#",
                                                target="_blank",
