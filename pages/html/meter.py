...
# Base meter Navbar
meter_navbar = dmc.MantineProvider(
...
meter_simulator_navbar = html.Div(
    # meter Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Meter() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Meter() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_meter",
)

meter_showcase = html.Div(
    [
        meter_navbar,
        html.Div(
            [
