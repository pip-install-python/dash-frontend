...
# Base Navbar
strong_navbar = dmc.MantineProvider(
...
strong_simulator_navbar = html.Div(
    # strong Simulator
    dmc.MantineProvider(
        theme={"colorScheme": "dark"},
        children=[
                ...
                [
                    ...
                    html.Div(
                        [
                            dmc.Container(
                                [
                                    dmc.Title("Custom html.Strong() Simulator", order=2),
                                    html.Div(
                                        [
                                            html.Label(
                                                "The dash.html.Strong() component is used to create hyperlinks. Here are some examples:",
                                                style={
                                                    "font-size": "14px",
    ...
    id="card_display_strong",
)

strong_showcase = html.Div(
    [
        strong_navbar,
        html.Div(
            [
